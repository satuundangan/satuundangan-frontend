...
const navItems = [
  ...
  { label: 'Resellers', to: '/admin/affiliate/resellers', icon: IconAffiliate },
  { label: 'Withdraw Queue', to: '/admin/affiliate/withdrawals', icon: IconWithdraw },
];
