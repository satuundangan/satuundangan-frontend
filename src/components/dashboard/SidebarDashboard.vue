<template>
  <aside class="w-64 bg-white border-r border-gray-100 flex flex-col h-screen fixed left-0 top-0 z-20">
    <div class="p-6 cursor-pointer border-b border-gray-100" @click="goToHome">
