<template>
  <Teleport to="body">
    <transition name="fade">
      <div v-if="show" class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 h-screen w-screen">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row relative animate-scale-up max-h-[90vh] md:max-h-[800px]">
          ...
          <div class="hidden md:flex md:w-5/12 bg-mocha relative flex-col justify-between p-10 text-white overflow-hidden">
             <!-- Background Pattern/Image -->
             <div class="absolute inset-0 opacity-20">
                <img src="https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover grayscale mix-blend-multiply" />
             </div>
             
             <div class="relative z-10">
                <div class="w-12 h-12 bg-white text-mocha rounded-xl flex items-center justify-center font-serif font-bold text-2xl mb-6 shadow-lg">S</div>
                ...
                <p class="text-white/80 text-sm leading-relaxed">
                   Buat undangan pernikahan digital impianmu dengan fitur premium dan desain eksklusif hanya di SatuUndangan.
                </p>
             </div>
          ...
          <div class="flex-1 p-8 md:p-12 flex flex-col justify-center overflow-y-auto">
            <div class="max-w-sm mx-auto w-full">
               ...
               <button @click="handleGoogleLogin"
                ...
                <img src="https://www.svgrepo.com/show/475656/google-color.svg" class="h-5 w-5 group-hover:scale-110 transition-transform" />
              ...
              <form @submit.prevent="authMode === 'login' ? handleLogin() : handleRegister()" class="space-y-4">
                ...
                <div class="space-y-1">
                   ...
                   <div class="relative">
                    ...
                    <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-mocha transition-colors"
                ...
                <button type="submit"
                  ...
                  <span>{{ loading ? 'Memproses...' : authMode === 'login' ? 'Masuk Sekarang' : 'Daftar Gratis' }}</span>
                </button>
