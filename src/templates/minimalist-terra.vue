<template>
  <div class="relative min-h-screen bg-[#f4f1ea] overflow-hidden font-sans no-scrollbar text-[#5d4037] selection:bg-[#e07a5f]/30">
    ...
    <nav v-if="!showWelcome"
      class="fixed bottom-6 inset-x-0 mx-auto z-50 bg-[#3d405b]/90 backdrop-blur-md rounded-2xl shadow-xl w-[92%] max-w-md md:hidden transition-all duration-500 flex overflow-x-auto no-scrollbar scroll-smooth">
